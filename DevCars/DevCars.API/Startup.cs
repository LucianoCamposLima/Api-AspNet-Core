...
namespace DevCars.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // For use database in memory
            // services.AddDbContext<DevCarsDbContext>(options => options.UseInMemoryDatabase(connectionString));
            ...
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1", new OpenApiInfo { 
                    ...
                    {
                        Name = "Luciano Campos Lima",
                        Email = "luciano.camposlima@yahoo.com.br"
                    }
                }
                );
            });
